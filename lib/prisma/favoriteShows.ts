...
export async function getFavoriteShow(favoriteShowID: string): Promise<{ favoriteShow?: FavoriteShow; error?: string; }> {
  try {
...
// Create a favorite
export async function createFavoriteShow(favoriteShow: Omit<FavoriteShow, "id">): Promise<{ favoriteShow?: FavoriteShow; error?: string }> {
  try {
...
export async function deleteFavoriteShow(favoriteShowID: string): Promise<{ favoriteShow?: FavoriteShow; error?: string }> {
  try {
